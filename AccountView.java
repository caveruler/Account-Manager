...
public class AccountView extends JFrameView {
	...
	public static JTextPane amountField;
	...
	private JPanel getButtonPanel()
	{
		if(buttonPanel == null){
			...
			GridBagConstraints DisButtonCtr = new GridBagConstraints();
			DisButtonCtr.gridx = 2;
			DisButtonCtr.gridy = 0;
			
			buttonPanel = new JPanel();
			buttonPanel.setLayout(new GridBagLayout());
			buttonPanel.add(getDepButton(), depButtonCtr);
			buttonPanel.add(getWithdrawButton(), wButtonCtr);
			buttonPanel.add(getDismissButton(), DisButtonCtr);
	...
	public static JTextPane getAmountField(){
		if(amountField == null){
			amountField = new JTextPane();
			amountField.setText(Double.toString(Account.getBalance()*0.01));
	...
	public static void main(String[] args) {
		...
		final AccountWindowController contr = new AccountWindowController();
		contr.setModel(account);
	    SwingUtilities.invokeLater(new Runnable() {
	      public void run() {
	    	  AccountWindowView app = new AccountWindowView(account, contr);
	    	  contr.setView(app);
	    	  app.setVisible(true);
	      }
	    });
